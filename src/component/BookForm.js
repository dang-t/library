...
function BookForm() {
    ...
    function handleSubmitForm(type, title, volume, author, key) {
        if (title === "" || volume === "" || author === "" || key === "") {
            toast.warn(
        ...
        fetch(`https://x9nifekwkb.execute-api.us-east-1.amazonaws.com/dev/add-to-library?key=${key}&title=${title}&type=${type}&volume=${volume}&author=${author}`)
            ...
            <div className="form-container">
                ...
                <div className="input-forms">
                    <div className="form1">
                        ...
                        <input id='volume-input' placeholder="Volume"></input>
                    </div>
                    <div className="form2">
                        <p>Author(s)</p>
                ...
                <div className="form-footer">
                    <button onClick={e => handleSubmitForm(novelType, document.getElementById("title-input").value, document.getElementById("volume-input").value, document.getElementById("author-input").value, document.getElementById("key-input").value)}>Add Book</button>
                </div>
            </div>
        </div>
    )
