    ...
    <>
      <div className='side-nav'>
        ...
        <div className='link-container'>
          <a className='active' href='#/' draggable="false">
          ...
          <a href='#/bookmarks' draggable="false">
      ...
      <div id='main' className='main-content'>
        ...
        <div className='book-db-container'>
          ...
          <div id='db-content'>
            ...
            {library.map(novel => {
              ...
              if (type === "ALL") {
                // all
                if (novel.title.toLowerCase().indexOf(search) === -1) return;
                return (createNovel(novel))
              } else if (type === "MANGA") {
                // manga
                if (novel.type === "Manga") {
                  if (novel.title.toLowerCase().indexOf(search) === -1) return;
